...
<?php if ( !is_home() && !is_page( 'Sitemap' ) ) : ?>
    ...
    <a class="sb-menu-toggle" id="sbMenuToggle" href="#sb-menu"><span class="open-menu">Quick menu access</span><span class="close-menu">Close menu</span></a>
        <?php
        wp_nav_menu( array(
            'menu'            => 'top-menu',
            'container'       => '',
...
?>
<?php $select_page_value = get_post_meta( get_the_ID(), 'select_page', true ); ?>
